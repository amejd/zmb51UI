					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hema-Quebec-Liste des donnees articles avec unites variables",
									"targetURL": "#zmb51ui-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zmb51ui-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmb51ui",
									"url": sap.ui.require.toUrl("zmb51ui")
								}
							}
						}
					}
